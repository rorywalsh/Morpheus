...
image bounds(37, 23, 484, 268), colour(90, 90, 90), plant("test"), identchannel("listbox"), visible(0), {
listbox bounds(2, 2, 478, 262), channel("rowListbox"), file("classicRows.txt"), value(-1), align("left"), highlightcolour(200, 200, 0)
}

image bounds(37, 23, 484, 268), colour(90, 90, 90), plant("test"), identchannel("matrix"), visible(1), {
...
button bounds(528, 24, 95, 20), channel("resetRow"), text("Reset Matrix"), popuptext("Reset matrix back to blank state")
button bounds(528, 72, 95, 20), channel("rand"), text("Randon Row"), popuptext("Fill matrix with random values")
button bounds(528, 48, 95, 20), channel("resetSearch"), text("Reset Search"), popuptext("Clear search pattern")
button bounds(528, 272, 95, 20), channel("norm"), text("Norm"), popuptext("Normalises matrix - sets first note in row to 0 and scales all other notes accordingly")

checkbox bounds(528, 296, 110, 20), channel("search"), fontcolour("black"), text("Search"), popuptext("Enable searched of matrix for a particular pattern")
label bounds(32, 456, 445, 14), colour("black"), visible(0), fontcolour("lime"), text(""), bold(0), identchannel("outputMessage")
button bounds(600, 322, 60, 25), channel("debug"), text("Debug")

groupbox bounds(35, 380, 490, 60), colour(160, 160, 160), fontcolour("black"), text("Search pattern"), plant("searchNotes"), visible(0), identchannel("searchNotesPlant"){
	label bounds(5,   30, 38, 20), text(""), fontcolour("black"), colour("white")    identChannel("searchnote_ident1")
	label bounds(45,  30, 38, 20), text(""), fontcolour("black"), colour("white")   identChannel("searchnote_ident2")
	label bounds(85,  30, 38, 20), text(""), fontcolour("black"), colour("white")   identChannel("searchnote_ident3")
	label bounds(125, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident4")
	label bounds(165, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident5")
	label bounds(205, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident6")
	label bounds(245, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident7")
	label bounds(285, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident8")
	label bounds(325, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident9")
	label bounds(365, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident10")
	label bounds(405, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident11")
	label bounds(445, 30, 38, 20), text(""), fontcolour("black"), colour("white")  identChannel("searchnote_ident12")
}

groupbox bounds(528, 120, 97, 47) text("Spelling"), fontcolour("black"), colour("White"), 
combobox bounds(536, 144, 80, 24), channel("spellingCombo"), items("Sharps", "Flats", "10", "t"), value(3), popuptext("Change harmonic spelling of notes")
groupbox bounds(528, 168, 95, 45) text("Permutations"), fontcolour("black"), colour("White")
combobox bounds(536, 192, 80, 24), channel("permutationsCombo"), items("Select", "Original", "P1", "P2", "P3", "P4")
groupbox bounds(528, 216, 96, 57) text("Modulation"), fontcolour("black"), colour("White")
combobox bounds(536, 240, 80, 24), channel("modulationsCombo"), items("Select", "Original", "M5", "M7", "M11"), popuptext("Transposes each note by a set interval")
button bounds(528, 96, 95, 20), channel("classicRows"), text("Classic Rows", "Show Matrix"), value(0), popuptext("Shows a list of iconic rows used in various 12-tone compositions")
...
;---------------------------------------
; opcode to colour a row or colum
;------------------------------------
