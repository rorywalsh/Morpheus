...
button bounds(528, 24, 95, 20), channel("resetRow"), text("Reset Matrix")
button bounds(528, 72, 95, 20), channel("rand"), text("Randon Row")
button bounds(528, 48, 95, 20), channel("resetSearch"), text("Reset Search")


checkbox bounds(535, 248, 110, 20), channel("search"), fontcolour("black"), text("Search")
...
combobox bounds(534, 120, 80, 24), channel("spellingCombo"), items("Sharps", "Flats", "10", "t"), value(3)
...
groupbox bounds(526, 192, 96, 57) text("Modulations"), fontcolour("black"), colour("White")
combobox bounds(534, 216, 80, 24), channel("modulationsCombo"), items("Select", "Original", "M5", "M7", "M11")
</Cabbage> 
<CsoundSynthesizer>
<CsOptions>
...
instr 1001
	...
	kPermute changed chnget:k("P1"), chnget:k("P2"), \
							chnget:k("P3")
	if kPermute == 1 then
		if kNoteCount < 12 then	
