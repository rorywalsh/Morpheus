...
image bounds(37, 23, 484, 268), colour(90, 90, 90), plant("test"){
...
button bounds(528, 248, 95, 20), channel("norm"), text("Norm"), popuptext("Normalises matrix - sets first note in row to 0 and scales all other notes accordingly")

checkbox bounds(528, 272, 110, 20), channel("search"), fontcolour("black"), text("Search"), popuptext("Enable searched of matrix for a particular pattern")
label bounds(32, 456, 445, 14), colour("black"), visible(0), fontcolour("lime"), text(""), bold(0), identchannel("outputMessage")
;button bounds(600, 322, 60, 25), channel("print"), text("Debug")
...
groupbox bounds(526, 96, 97, 47) text("Spelling"), fontcolour("black"), colour("White"), 
combobox bounds(534, 120, 80, 24), channel("spellingCombo"), items("Sharps", "Flats", "10", "t"), value(3), popuptext("Change harmonic spelling of notes")
groupbox bounds(526, 144, 95, 45) text("Permutations"), fontcolour("black"), colour("White")
combobox bounds(534, 168, 80, 24), channel("permutationsCombo"), items("Select", "Original", "P1", "P2", "P3", "P4")
groupbox bounds(526, 192, 96, 57) text("Modulation"), fontcolour("black"), colour("White")
combobox bounds(534, 216, 80, 24), channel("modulationsCombo"), items("Select", "Original", "M5", "M7", "M11"), popuptext("Transposes each note by a set interval")
</Cabbage> 
<CsoundSynthesizer>
<CsOptions>
