...
button bounds(424, 448, 98, 25), channel("print"), text("Print Matrix")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
...
opcode print2DArrayContents, 0, i[][]i
iArray[][], iRow xin
...
instr 1008
		print2DArrayContents(giMatrix, 0)
		print2DArrayContents(giMatrix, 1)
		print2DArrayContents(giMatrix, 2)
		print2DArrayContents(giMatrix, 3)
		print2DArrayContents(giMatrix, 4)
		print2DArrayContents(giMatrix, 5)
		print2DArrayContents(giMatrix, 6)
		print2DArrayContents(giMatrix, 7)
		print2DArrayContents(giMatrix, 8)
		print2DArrayContents(giMatrix, 9)
		print2DArrayContents(giMatrix, 10)
		print2DArrayContents(giMatrix, 11)
endin
;-------------------------------------------
