...
button bounds(15, 25, 40, 20),  fontcolour("black"), channel("M5"), text("M5")
button bounds(85, 25, 40, 20),  fontcolour("black"), channel("M7"), text("M7")
button bounds(15, 45, 40, 20), fontcolour("black"), channel("M11"), text("M11")
}                             
