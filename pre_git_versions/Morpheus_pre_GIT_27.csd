...
image bounds(32, 7, 490, 15), colour("white"), plant("inverseLabels"){
...
image bounds(32, 290, 490, 15), colour("white"), plant("retroInverseLabels"){
...
image bounds(13, 26, 25, 280), colour("white"), plant("primeLabels"){
...
image bounds(522, 26, 20, 280), colour("white"), plant("retroLabels"){
...
checkbox bounds(560, 296, 110, 20), channel("search"), fontcolour("black"), text("Search"), popuptext("Enable searched of matrix for a particular pattern")
...
groupbox bounds(560, 120, 97, 47) text("Spelling"), fontcolour("black"), colour("White"), 
combobox bounds(568, 144, 80, 24), channel("spellingCombo"), items("Sharps", "Flats", "10", "t"), value(3), popuptext("Change harmonic spelling of notes")
groupbox bounds(560, 168, 95, 45) text("Permutations"), fontcolour("black"), colour("White")
combobox bounds(568, 192, 80, 24), channel("permutationsCombo"), items("Select", "Original", "P1", "P2", "P3", "P4")
groupbox bounds(560, 216, 96, 57) text("Modulation"), fontcolour("black"), colour("White")
combobox bounds(568, 240, 80, 24), channel("modulationsCombo"), items("Select", "Original", "M5", "M7", "M11"), popuptext("Transposes each note by a set interval")
